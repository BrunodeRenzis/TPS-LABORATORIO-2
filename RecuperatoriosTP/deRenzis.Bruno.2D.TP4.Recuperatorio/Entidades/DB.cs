    ...
    public static class DB
    {
        ...
        public static List<Producto> Leer()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    {
                        listaProductos.Add(new Producto(reader["nombreProducto"].ToString(), double.Parse(reader["PrecioProducto"].ToString()),
                        Producto.ETipoProducto.SinEspecificar, int.Parse(reader["cantidadProducto"].ToString()), int.Parse(reader["idProducto"].ToString())));
                    }
        ...
        public static bool AgregarProducto(Producto unProducto)
        {
            string sql = "Insert into Productos(nombreProducto,cantidadProducto, precioProducto, tipoProducto) " +
                "values(@auxNombre, @auxCantidad, @auxPrecio, @auxTipo)";
        ...
        {
            string sql = "Update Productos Set nombreProducto = @auxNombre, " +
                "cantidadProducto = @auxCantidad, precioProducto = @auxPrecio,  tipoProducto = @auxTipo where idProducto = @auxID";
