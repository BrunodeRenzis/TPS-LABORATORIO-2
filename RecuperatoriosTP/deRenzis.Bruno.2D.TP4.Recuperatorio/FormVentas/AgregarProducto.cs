    ...
    public partial class AgregarProducto : Form
    {
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if ((Producto.ETipoProducto)this.comboBoxTipo.SelectedValue == Producto.ETipoProducto.SinCadenaFrio)
                {
                ...
                {
                    auxProd = new Producto(this.textBoxNombre.Text, double.Parse(this.textBoxPrecio.Text), Producto.ETipoProducto.SinEspecificar, int.Parse(this.textBoxCantidad.Text));
